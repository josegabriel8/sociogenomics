...
# Sociogenomics Final Project 2022/2023

This work was in collaboration with José  Escarraman, Benedetta Felici, and Valentina Idda. As a part of the Sociogenomics course of the MAster degree in Statistical Sciences at the University of Bologna.


# Overview
This project is centered around the field of sociogenomics, which explores the intersection of genetics and social behaviors or traits. Sociogenomics seeks to understand how genetic variations contribute to complex human traits and behaviors, often incorporating both genetic and sociological data.

Overview of the Project:
The project involves multiple stages of data analysis, primarily using genomic data and associated software tools like PLINK and PRSice-2. The project is divided into three parts:
